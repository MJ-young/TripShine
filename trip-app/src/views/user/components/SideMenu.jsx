...
import icon_service from "@/assets/icon/icon_service.png";
import icon_draft from "@/assets/icon/icon_draft.png";
import icon_create_center from "@/assets/icon/icon_create_center.png";
import icon_community from "@/assets/icon/icon_community.png";
...
export const sideMenuRef = React.createRef();
